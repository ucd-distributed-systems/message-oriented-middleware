...
public class Main {
    ...
    public static void main(String[] args) throws JMSException {
        ...
        String connectionId = "girlsallowedMain";
        ...
        // connect girlsallowed to Quotations queue and Orders topic
        MessageConsumer consumer = session.createConsumer(topic);
        // girlsallowed adds quotations to the queue
        ...
        consumer.setMessageListener(new MessageListener() {
            ...
            public void onMessage(Message message) {
                try {
                    ...
                    Quotation quotation = gaqService.generateQuotation(
