...
public class Main {
    ...
    public static void main(String[] args) throws JMSException {
        ...
        String connectionId = "dodgygeezersMain";
        ...
        // connect dodgygeezers to Quotations queue and Orders topic
        MessageConsumer consumer = session.createConsumer(topic);
        // dodgygeezers adds quotations to the queue
        ...
        consumer.setMessageListener(new MessageListener() {
            ...
            public void onMessage(Message message) {
                try {
                    ...
                    Quotation quotation = dgqService.generateQuotation(
